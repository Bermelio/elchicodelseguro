    ...
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-start pt-50 items-start px-6 md:px-16">
        <div className="max-w-xl text-white">
          ...
          <div className="mt-8">
            <button className="bg-azul-oscuro-custom hover:bg-blue-800 text-white font-semibold py-3 px-6 rounded-full shadow-lg transition-transform duration-150 hover:scale-105">
