...
- **Propósito:** Ofrecer seguros (auto, hogar, vida, lo que sea) explicados en tu idioma, sin tecnicismos raros ni sorpresas.
...
| :---------------- | :------------------------------------------------------------------------- |
| **Vite**          | Empaquetador y entorno de desarrollo de próxima generación.               |
| **React** (v19.x) | Biblioteca principal para construir la interfaz de usuario.               |
| **TypeScript**    | Tipado estático para un código más robusto y escalable.                   |
| **Tailwind CSS**  | Framework CSS *utility-first* para un diseño ágil y responsive.           |
| **GSAP**          | Biblioteca profesional para animaciones fluidas y de alto rendimiento.    |
| **EmailJS**       | Manejo del envío del formulario de contacto sin necesidad de backend.     |
...
```bash
git clone https://github.com/Bermelio/elchicodelseguro
cd elchicodelseguro
